"""Built-in filesystem and shell tools for Pi coding sessions.
...
filesystem/shell behavior outside the reusable `pi_agent` package.
"""
...
from erp_harness.runtime.messages import ImageContent, TextContent
...
from erp_harness.tools.image_processing import (
...
def create_coding_tools(
    *,
    ...
    The returned tools are ordered as Pi's `read`, `bash`, `edit`, and `write`.
