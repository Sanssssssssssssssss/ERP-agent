...
from erp_harness.providers.oauth import OpenAICodexOAuthProvider
from erp_harness.providers.oauth_anthropic import AnthropicOAuthProvider
from erp_harness.providers.oauth_github_copilot import GitHubCopilotOAuthProvider
...
def oauth_provider_ids() -> frozenset[str]:
    """Return IDs accepted by Pi's subscription login flow."""
