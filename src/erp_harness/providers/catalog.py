"""Built-in provider catalog for Pi login/setup flows."""
...
class ProviderCatalogEntry:
    """A built-in provider Pi can present during login."""
...
def _load_builtin_catalog() -> tuple[ProviderCatalogEntry, ...]:
    ...
    from erp_harness.providers.catalog_loader import builtin_catalog
