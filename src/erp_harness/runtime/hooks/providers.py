...
from erp_harness.runtime.types import JSONPrimitive, JSONValue
from erp_harness.providers.env import (
    DEFAULT_OPENAI_COMPATIBLE_MAX_RETRIES,
    DEFAULT_OPENAI_COMPATIBLE_MAX_RETRY_DELAY_SECONDS,
    DEFAULT_OPENAI_COMPATIBLE_TIMEOUT_SECONDS,
)
from erp_harness.providers.catalog import ModelInput, ProviderApi
...
class RequiredApiKey:
    """Resolve a required API key from Pi credentials, then the environment."""
...
class OpenAICompatibleTransport:
    """Descriptor for Pi's existing OpenAI-compatible streaming transport.
    ...
    lifetime. Normal transports leave it unset and use Pi's standard client.
    """
