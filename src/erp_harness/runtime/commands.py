...
from erp_harness.providers.catalog import BUILTIN_PROVIDER_CATALOG, builtin_provider_entry
...
from erp_harness.providers.thinking import normalize_thinking_level
...
def _theme_command(context: CommandContext) -> CommandResult:
    ...
    from erp_harness.runtime.exporting.themes import available_tui_theme_names
