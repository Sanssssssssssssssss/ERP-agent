...
Please do not open a public issue for credentials, private Odoo data, authentication material, or a reproducible security vulnerability. Use the repository's [private vulnerability report form](https://github.com/Sanssssssssssssssss/odoo-agent/security/advisories/new) when it is enabled; otherwise contact the maintainers privately with the affected path, version or commit, reproduction steps, and impact.
