...
from pi_coding.models_dev import (
    MODELS_DEV_URL,
    NVIDIA_MODELS_URL,
...
def models_store_path(paths: PiPaths | None = None) -> Path:
    return (paths or PiPaths()).models_store_path
...
def cached_models_dev_catalog_overlay(paths: PiPaths | None = None) -> dict[str, Any] | None:
...
async def refresh_models_dev_catalog(
    *,
    ...
    try:
        ...
        from pi_coding.catalog_loader import builtin_source_catalog
...
def _read_cache(paths: PiPaths | None) -> dict[str, Any] | None:
