...
import pi_coding.built_in_extensions as built_in_extension_registry
from pi_agent.events import AgentEvent, AgentStartEvent, MessageEndEvent
...
from pi_agent.messages import AgentMessage, TextContent, convert_to_llm
...
from pi_coding.built_in_extensions import BuiltInExtension, BuiltInExtensionContext
from pi_coding.commands import (
    CommandContext,
    CommandRegistry,
    CommandResult,
    SlashCommand,
...
from pi_coding.credentials import CredentialStore, FileCredentialStore, credentials_path
...
from pi_coding.extensions.providers import CredentialReader, DynamicProvider
from pi_coding.local_backends import LocalBackend, LocalBackendRegistry
from pi_coding.paths import PiPaths
from pi_coding.project_trust import ExtensionTrustResult, ProjectTrustEvent
from pi_coding.provider_config import ProviderConfig
from pi_coding.resources import PiResourcePaths, ResourceDiagnostic
...
class ExtensionRuntime:
    ...
    def __init__(
        ...
        *,
        ...
        built_in_paths = paths or PiPaths()
