...
from pi_agent.events import AgentEndEvent, AgentEvent, MessageEndEvent, ToolExecutionEndEvent
from pi_agent.harness import AgentHarness, AgentHarnessConfig, QueuedMessages
from pi_agent.loop import AgentContext, AgentLoopTurnUpdate, TurnContext
...
from pi_agent.provider_events import AssistantDoneEvent, AssistantErrorEvent, TextDeltaEvent
...
from pi_agent.session.entries import SessionEntry
from pi_agent.session.jsonl import entry_to_json_line
from pi_agent.session.tree import SessionTreeError, path_to_entry
from pi_agent.tool_history import ToolHistoryRepair, repair_tool_history
...
from pi_ai.provider import ProviderHooks
from pi_ai.retry import is_retryable_assistant_error
from pi_coding.branch_summary import (
...
from pi_coding.commands import CommandRegistry, CommandResult, create_default_command_registry
from pi_coding.context import discover_project_context_with_diagnostics
from pi_coding.context_window import (
...
from pi_coding.credentials import FileCredentialStore, credentials_path
from pi_coding.diagnostics import (
    AgentCallDiagnosticContext,
    AgentCallDiagnosticLogger,
    new_agent_call_run_id,
)
from pi_coding.events import (
    AgentSettledEvent,
    AutoRetryEndEvent,
    AutoRetryStartEvent,
    CodingSessionEvent,
...
from pi_coding.extensions.provider_registry import DynamicProviderRegistry
from pi_coding.extensions.providers import DynamicProvider, ProviderModel
from pi_coding.extensions.runtime import ExtensionRuntime
from pi_coding.models_dev_store import ModelsDevRefreshResult, refresh_models_dev_catalog
from pi_coding.paths import PiPaths
from pi_coding.project_trust import (
...
from pi_coding.prompt_templates import (
    PromptTemplate,
...
from pi_coding.provider_runtime import (
    ClosableModelProvider,
    create_dynamic_model_provider,
    create_model_provider,
)
from pi_coding.reload import CodingReloadSummary, ReloadCategorySummary
...
from pi_coding.session_export import (
    default_session_export_artifact_path,
    export_session_artifact,
    normalize_export_format,
)
from pi_coding.session_manager import (
    InferenceProviderMode,
    SessionManager,
    normalize_session_name,
)
from pi_coding.session_stats import SessionStats, calculate_session_stats
from pi_coding.skills import Skill, expand_skill_command, load_skills_with_diagnostics
from pi_coding.system_prompt import (
    BuildSystemPromptOptions,
    ProjectContextFile,
    build_system_prompt,
)
from pi_coding.thinking import (
...
from pi_coding.tools import ImageSupportState, create_bash_tool, create_coding_tools
...
class CodingSessionConfig:
    ...
    resource_paths: PiResourcePaths | None = None
...
class CodingSession:
    ...
    async def load(cls, config: CodingSessionConfig) -> CodingSession:
        ...
        runtime_paths = unfiltered_resource_paths.paths or PiPaths(
        ...
        coordinator = config.project_trust_coordinator or ProjectTrustCoordinator(
            ProjectTrustStore(
                unfiltered_resource_paths.paths or PiPaths(home=unfiltered_resource_paths.root)
            )
        )
    ...
    async def reload(self) -> CodingReloadSummary:
        ...
        self._harness.config.transform_context = staged_runtime.transform_context
...
def default_session_path(cwd: Path) -> Path:
    ...
    return PiPaths().default_session_path(cwd)
