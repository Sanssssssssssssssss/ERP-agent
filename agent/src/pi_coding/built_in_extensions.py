...
from pi_coding.credentials import CredentialStore
...
def _llama_cpp_setup(api: ExtensionAPI) -> None:
    ...
    from pi_coding.extensions.builtins.llama_cpp import setup
...
# project inputs cannot change what Pi treats as trusted.
