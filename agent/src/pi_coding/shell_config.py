...
from pi_coding.project_trust import TrustDefault
...
def shell_settings_path(paths: PiPaths | None = None) -> Path:
    """Return the durable shell settings path."""
    return (paths or PiPaths()).home / "settings.json"


def load_shell_settings(paths: PiPaths | None = None) -> ShellSettings:
