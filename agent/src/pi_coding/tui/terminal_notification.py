"""Best-effort terminal attention notifications for completed Pi turns."""
...
from pi_coding.tui.config import TurnNotificationMode
from pi_coding.tui.terminal_title import sanitize_terminal_title

OSC_TERMINATOR = "\a"
TURN_FINISHED_MESSAGE = "Pi turn finished"
...
def terminal_notification_supported(
    *,
    ...
    """Return whether Pi may write attention sequences to this terminal."""
