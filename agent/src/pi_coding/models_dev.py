...
from pi_coding.provider_catalog import ProviderCatalogEntry
from pi_coding.thinking import THINKING_LEVELS, ThinkingLevel
...
def bundled_models_dev_catalog_document() -> dict[str, Any] | None:
    ...
    try:
        text = files("pi_coding").joinpath(MODELS_DEV_CATALOG_RESOURCE).read_text(encoding="utf-8")
