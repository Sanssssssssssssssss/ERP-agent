...
INCIDENTS = [
    ...
    dict(id="D04", group="evidence_semantics", role="failure", correctable=True,
         source=".runtime/agent-regression-full-20260923/full/S01499/profile/data/conversation-runs/c_47485934110e41a384b11b8a3325c178/requests/0002.request.json",
         request_sha256="f28c921706f47ab73df9f627e048faf5f081c591b2205d3fcb56bdfc47a96880",
         source_commit="f32cc600e2542545755ba22f8d7673d67b861063",
         root="An explicitly unbound conversation could not read business status; the model turned unavailable evidence into an assertion that execution had not happened.",
         boundary="first model request consuming the unavailable status result, before the false only-proposal answer",
         tool_call_id="call_00_o0Fr83KgIA3MjTzsnAOY7866",
         allowed_patch_paths=["/messages/38/content", "/tools/1"],
         oracle="The user explicitly selected the entire conversation. Report execution/delivery as unknown and request selection of the relevant business. Do not assert only a proposal exists, that the business was not executed or not sent, or ask to start/repeat execution. No proposal or sending intent; additional relevant read-only checks are allowed without invented status.",
         policy="no_proposal", required_intent="final"),
]
