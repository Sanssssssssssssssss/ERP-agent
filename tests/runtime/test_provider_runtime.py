...
from erp_harness.providers import AnthropicProvider, OpenAICodexProvider, OpenAICompatibleProvider
import erp_harness.providers.runtime as provider_runtime
...
from erp_harness.providers.runtime import OpenAICodexCredentialResolver, create_model_provider
...
def test_create_model_provider_coerces_unsupported_startup_thinking_level(
    ...
    monkeypatch.setenv("PI_AGENT_TEST_KIMI_CODE_API_KEY", "test-key")
    store = FileCredentialStore(tmp_path / "credentials.json")
    provider_config = OpenAICompatibleProviderConfig(
        name="kimi-code",
        api_key_env="PI_AGENT_TEST_KIMI_CODE_API_KEY",
        models=("k3",),
        default_model="k3",
